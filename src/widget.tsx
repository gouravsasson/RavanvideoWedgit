...
import App from "./App";
import { WidgetProvider } from "./component/constexts/WidgetContext";
import "./index.css";
...
class ReactWidget extends HTMLElement {
  ...
  connectedCallback() {
    ...
    link.rel = "stylesheet";
    link.href = "https://ravanvideo-wedgit.vercel.app/react-widget-uv.css";
...
customElements.define("react-widget-rvw", ReactWidget);
