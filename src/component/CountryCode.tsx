  ...
  return (
    ...
    >
      ...
      <div
        ...
        className=" text-black cursor-pointer rounded-r-none bg-white/60 backdrop-blur-sm border border-gray-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 rounded-xl px-4 py-3  flex items-center justify-between"
      >
